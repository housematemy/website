...
import TermsImg from "../assets/images/tos-img1.jpg"
          ...
          <div className="row">
            <div className="col-lg-8 col-md-12">
              <div className="terms-of-service-content">
                <p>
                  <i>
                    This Terms of Service was last updated on July 19, 2023.
                  </i>
                </p>
                <h3>1. Our website</h3>
                <p>
                  Our website address is: <strong>http://www.housemate.my</strong>
                </p>
                <blockquote className="blockquote">
                  <p>
                    ...
                    with <strong>Housemate</strong>. We also collect some data
